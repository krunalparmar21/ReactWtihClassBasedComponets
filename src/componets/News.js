...
export class News extends Component {
    ...
    async updateNews(pageNo){
        ...
        const url =`https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=1e425d291d0341f29420f735ce775bd5&
    ...
    async componentDidMount(){
        // console.log('cdm');
        // let url =`https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=1e425d291d0341f29420f735ce775bd5&page=1&pageSize=${this.props.pageSize}`;
        // this.setState({loading: true});
    ...
    handlePreviousClick = async ()=>{
        ...
        // let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=1e425d291d0341f29420f735ce775bd5&page = ${this.state.page + 1}&pageSize=${this.props.pageSize}`;
        // this.setState({loading: true});
  ...
  render() {
    return (
      <div className='container my-3'>
           <h1 className="text-center" style={{margin:'35px 0px'}}>NewsMonket - Top 
